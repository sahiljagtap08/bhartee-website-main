  ...
  return (
    <section className="py-60 w-full  overflow-hidden relative z-30">
      <div className="bg-white dark:bg-black">
        ...
        <CardSpotlight> <div className="relative -mx-6   sm:mx-0 sm:rounded-2xl overflow-hidden px-6  md:px-8 ">
          ...
          <div className="relative px-6 pb-14 pt-20 sm:px-10 sm:pb-20 lg:px-[4.5rem]">
            ...
            <p className="mt-4 max-w-[26rem] text-center mx-auto  text-base/6 text-neutral-200">
              <Balancer>
                Get early access to the best AI recruiter in the world and join
                the waitlist.
              </Balancer>
            </p>

            <div className="relative z-10 mx-auto flex justify-center mt-6">
              <Link href="/signup"> <Button>Join Waitlist</Button></Link>
