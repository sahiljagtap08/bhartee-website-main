...
export const Footer = () => {
  ...
  //here the type of legal is explicitly defined and initialized, because we have commented out the code that would have inferred the type
  ...
  const socials = [
    {
      name: "Twitter",
      href: "https://twitter.com/twtofsahil",
    },
    {
      name: "LinkedIn",
      href: "https://linkedin.com/company/bhartee-ai",
    },
    {
      name: "GitHub",
      ...
      <div className="border-t border-neutral-100  dark:border-neutral-800 px-8 pt-20 pb-32 relative bg-white dark:bg-black">
        <div className="max-w-7xl mx-auto text-sm text-neutral-500 dark:text-neutral-400 flex sm:flex-row flex-col justify-between items-start ">
          <div>
            ...
            <div>Copyright &copy; 2024 Bhartee LLC</div>
